...
void fitsForFTest_pT455_dat()
{
  ...
  for (int i = 0; i < N; ++i) {
    tree->GetEntry(i);
    if (lj1_isXbb_60>=1 && (lj1_pt >=450 && lj1_pt < 500) && lj1_nVRjets >=2)
    { 
      lj1_Xbb60 = lj1_mass;
...
TString data_18 = "../data18.root";
  ...
  for (int i = 0; i < n; ++i) {
    tree_18->GetEntry(i);
    if (lj1_isXbb_60_18>=1 && (lj1_pt_18 >=450 && lj1_pt_18 < 500) && lj1_nVRjets_18 >=2)
    { 
  ...
  //TString FuncType[4] = {"1st_exp", "2nd_exp", "3rd_exp","4th_exp"};
  //TString FuncType[3] = { "2nd_exp", "3rd_exp","4th_exp"};
  //TString FuncType[2] = {"2nd_exp", "3rd_exp"};
  ...
  { 
    ...
    { 
      ...
      /*RooRealVar c0("c0","c0",-0.4,-1,1);
      RooRealVar c1("c1","c1",-0.3,-1,1);*/
    ...
    {   
        npars = 3;
        /*RooRealVar c0("c0","c0",100,0,1e5);
        RooRealVar c1("c1","c1",-100,-100,1e5);
        RooRealVar c2("c2","c2",100,-100,1e4);*/
    ...
    {   
        npars = 4;
        /*RooRealVar c0("c0","c0",100,-100,1e4);
        RooRealVar c1("c1","c1",-100,-100,1e5);
        RooRealVar c2("c2","c2",100,-100,1e4);
        RooRealVar c3("c3","c3",30,-100,100);*/
    ...
    {   
        ...
        RooRealVar c3("c3","c3",70,-200,200);
        RooRealVar c4("c4","c4",-70,-200,200);
        RooRealVar c5("c5","c5",-70,-200,200);*/
  ...
  TLatex * pT = new TLatex(0.15,0.41,"pT=[450,500] GeV");
  pT->SetNDC();
  pT->SetTextFont(42);
  pT->SetTextColor(1);
  pT->SetTextSize(0.04);
  ...
  probi->Draw();
   ...
   //gPad->SetTicks();
   gPad->SaveAs("./FTestFits/"+FuncType[i]+"pT455_UnBinned_lj1mass_Xbb60_SB5080_dat18.pdf");
   //gPad->delete();
  }
