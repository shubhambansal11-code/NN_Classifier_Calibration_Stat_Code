...
void fitsForFTest_pT455_QCD()
{
  ...
  //TTree* tree = getTTree() ;
  TString data_1517 = "../QCD_455.root";
  ...
  probi->Draw();
   gPad->SaveAs("./FTestFits/"+FuncType[i]+"UnBinned_lj1mass_Xbb60_pT455_SBRangeChange_QCD.pdf");
   //gPad->delete();
  }
